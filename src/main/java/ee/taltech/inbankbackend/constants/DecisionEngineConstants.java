package ee.taltech.inbankbackend.constants;
...
public class DecisionEngineConstants {
    ...
    public static final Integer MAXIMUM_LOAN_PERIOD = 48;   //was 60
    ...
    public static final Integer MAXIMUM_AGE_ESTONIA = 73;
    public static final Integer MAXIMUM_AGE_LATVIA = 71;
    public static final Integer MAXIMUM_AGE_LITHUANIA = 70;
